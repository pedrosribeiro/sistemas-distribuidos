...
from app.ms_reserva.service import (
    consultar_itinerarios,
    criar_reserva,
    cancelar_reserva,
    registrar_interesse_promocoes,
    cancelar_interesse_promocoes,
...
ITINERARIOS_SERVICE_URL = "http://localhost:5002"
PAGAMENTO_SERVICE_URL = "http://localhost:5003"
...
def consultar_itinerarios():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return jsonify({"erro": "Erro ao consultar itinerários"}), 500
...
def health_check():
    ...
    return jsonify({"status": "healthy", "service": "ms_reserva"}), 200
